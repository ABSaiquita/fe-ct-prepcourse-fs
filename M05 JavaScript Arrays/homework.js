...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var palabrasConcat = palabras.join(" ");
...
function tablaDelSeis() {
   ...
   var tablaDelSeis = numeros.map(function(numero){
      return numero * 6;
   });
   return tablaDelSeis;
}
